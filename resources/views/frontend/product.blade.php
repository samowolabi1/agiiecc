                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <!-- Vendor Contact Card -->
<div class="container" style="max-width: 450px; padding: 20px; margin: 30px auto; text-align: left; font-family: Arial, sans-serif; border-left: 4px solid #8fc74a;">
    <div class="contact-card">
        <!-- Vendor Name -->
        <h5 style="font-size: 22px; font-weight: bold; color: #333; margin-bottom: 10px;">Igheya Goodluck</h5>
        
        <!-- Vendor Position/Business Name -->
        <p style="font-size: 16px; color: #555; margin-bottom: 5px;">Vendor at AGii Marketplace</p>
        
        <!-- Availability -->
        <p style="font-size: 14px; color: #777; margin-bottom: 15px;">Business Name: <strong>MENA STORE</strong></p>
        
        <!-- Contact Information -->
        <div style="padding: 10px 0; margin-bottom: 15px;">
            <p style="font-size: 16px; color: #333; margin: 0; font-weight: bold;">Contact: +234 801 234 5678</p>
            <p style="font-size: 14px; color: #555; margin: 5px 0;">Email: goodluck@vendor.com</p>
            <p style="font-size: 14px; color: #555; margin: 0;">Location: Lagos, Nigeria</p>
        </div>
        
        <!-- Buttons -->
        <button class="btn btn-primary" style="background-color: #8fc74a; border: none; color: #ffffff; padding: 10px 20px; border-radius: 4px; cursor: pointer; font-size: 14px; font-weight: bold; margin-bottom: 10px;">
            Show More Details
        </button>
        <button class="btn btn-secondary" style="background-color: #6c757d; border: none; color: #ffffff; padding: 10px 20px; border-radius: 4px; cursor: pointer; font-size: 14px; font-weight: bold;">
            Start Chat
        </button>
    </div>
</div>
                    ...
                    <div class="product-details-tab">
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="product-info-link" data-toggle="tab" href="#product-info-tab" role="tab" aria-controls="product-info-tab" aria-selected="false"> Bio Details </a>
                            </li>
                        <li class="nav-item">
