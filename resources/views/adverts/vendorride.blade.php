            ...
            <div class="m-3 row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <form action="{{route('create_rider_store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="control-label">Car Brand</label>
                                            <select class="form-control" name="carbrand_id" required>
                                                <option value="" selected disabled>Pick a car brand</option> <!-- Fix: Added value="" and disabled -->
                                                @foreach($carbrands as $bd)
                                                    <option value="{{$bd->id}}">{{$bd->name}}</option>
                                                @endforeach
                                            </select>
