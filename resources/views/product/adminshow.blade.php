...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Vendor Product Information</h1>
        <!-- @if(!empty($company)) -->
                                           ...
                                           <div class="col-md-12">
                                            ...
                                            <table style="border:0px;" class="table table-hover">
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="border:0px;">&#x20a6;{{number_format($product->price ?? '')}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="border:0px;">{{$product->created_at->isoFormat('MMMM Do YYYY')}}</td>
                                                </tr>

                                                <tr>
                                                  <td style="border:0px;"><strong>Status: </strong></td>
                                                  <td style="border:0px;">{{$product->status ?? ''}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <td style="border:0px;" class="text-primary">{{$product->created_by ?? ''}}</td>
                                                </tr>
                                  ...
                                  <div>
                                      <div class="card-body">
                                        ...
                                        <div class="row">
                                            <br>
                                            <div class="col-md-6">
                                            <a href="{{route('admin.approve.product',$product->id)}}" class="btn btn-info">Change Approved</a>
                                            
                                        </div>

                                        <div class="col-md-6">
                                            <a href="{{route('admin.status.product',$product->id)}}" class="btn btn-info">Change Status</a>
