...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Vendor Ride Information</h1>
        <!-- @if(!empty($company)) -->
                                  ...
                                  <div>
                                      <div class="card-body">
                                        ...
                                        <div class="row">
                                            <br>
                                            <div class="col-md-6">
                                            <a href="{{route('admin.approve.ride',$ride->id)}}" class="btn btn-info">Change Approved</a>
                                            
                                        </div>

                                        <div class="col-md-6">
                                            <a href="{{route('admin.status.ride',$ride->id)}}" class="btn btn-info">Change Status</a>
